...
**Spec de référence:** `docs/superpowers/specs/2026-05-09-memoria-mvp-design.md` § 7 « Vision V2 — Atelier IA » (vision documentée). Ce plan transforme la vision en MVP fonctionnel.
