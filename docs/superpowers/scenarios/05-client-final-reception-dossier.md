...
Mardi 14 mai, 10h47. Sylvie est sur Outlook, écran double, 11 onglets Chrome, café froid à côté du clavier. Le mail de Guillaume arrive et sort du flot parce qu'il est court — quatre lignes. Elle le lit en deux secondes. Le mot qui accroche, c'est « salle 312 ». C'est l'incident remonté il y a dix jours par l'infirmière chef du service oncologie qui a trouvé un chariot mal essuyé. Sylvie a écrit à Guillaume le 6 mai, sec, en mode « merci de me confirmer que ça ne se reproduira pas ». Guillaume lui répond avec un lien, dix jours après. Bon point ou mauvais point ? Elle ne sait pas encore.
...
1. **Authentification visuelle** : « C'est bien à propos de la salle 312, c'est bien mon contrat, c'est bien mon site. Donc Guillaume ne m'a pas envoyé un truc générique. »
2. **Évaluation d'autorité** : « Qu'est-ce que c'est que cet outil ? Guillaume s'est payé une plateforme ? Ou c'est un truc bricolé ? »
3. **Évaluation d'effort** : « Combien de temps je vais y passer ? J'ai un comité qualité à 11h30. »

Elle compare instantanément à ce qu'elle recevait avant. Avant, c'était un PDF Word avec le logo couleur de l'entreprise de Guillaume en haut, une signature scannée de Guillaume en bas, deux ou trois photos jointes en pièces séparées dans le mail. C'était moche mais c'était **incarné** — c'était Guillaume. Là, c'est plus propre, plus moderne, plus pro… mais c'est aussi plus froid. Plus anonyme. Moins « Guillaume ».
...
**Méfiance professionnelle de base.** Pas dirigée contre Guillaume, dirigée contre la situation. Elle a 49 ans, 25 ans dans la fonction publique hospitalière. Elle sait qu'un prestataire qui produit ses propres preuves de son propre incident est dans une position délicate. Le document est intéressé par construction.
...
**Fatigue managériale.** Elle gère sept prestataires. Si chacun se met à lui envoyer des liens dans une plateforme différente, sa vie devient invivable. Mentalement, elle commence à se demander si elle ne va pas dire à Guillaume : « envoie-moi juste le PDF, je n'ouvrirai plus le lien ».

**Ce qu'elle dit à Marie-Claire à côté** (sa collègue chargée du marché restauration) : *« Guillaume m'a envoyé un truc bien plus clean que d'habitude pour la 312. Avec des photos horodatées et tout. Bon, ça reste lui qui te dit qu'il a bien nettoyé sa propre chambre, hein. Mais c'est mieux fichu. »* Marie-Claire répond *« Tu vas le garder ou tu mets en concurrence ? »* Sylvie : *« Je verrai. Au moins j'ai un truc à montrer en réunion. »*

## 3. Ce qu'elle cherche vraiment

Elle ne cherche **pas** un rapport. Elle cherche trois choses, dans cet ordre :

**(a) La preuve que Guillaume prend l'incident au sérieux.** Le fait qu'il existe un document structuré, daté, avec photos, est en soi le signal. Le contenu compte moins que l'existence. Si Guillaume avait répondu par mail « c'est résolu, à plus », c'était mort. Le simple fait qu'il y ait un objet artefactuel — un truc qu'on peut télécharger, classer, montrer — change la dynamique.
...
**(c) La signature que ce n'est pas inventé.** Et c'est là que MemorIA a quelque chose d'unique. Les horodatages serveurs des photos, le QR de vérification, le fait que le lien soit hébergé ailleurs que sur le Drive de Guillaume — tout ça envoie le signal *« ce n'est pas un document que Guillaume a tapé hier soir dans Word ».* Sylvie ne va pas faire le test du QR. Mais le fait qu'il existe la rassure.
...
**4. Pas de signature humaine.** Le PDF n'a pas de signature scannée de Guillaume. Pas de cachet d'entreprise. Pas de « Bien à toi, Guillaume, DG de NetCal ». Le document est **désincarné**. Pour Sylvie qui apprécie Guillaume depuis 4 ans, le document semble venir d'une machine — alors qu'elle voulait Guillaume. Le rapport mensuel a la note DG ; le dossier d'incident, lui, n'a rien d'équivalent. Trou flagrant.

**5. Pas de logo client de Guillaume.** L'entreprise de Guillaume, « NetCal », n'apparaît qu'en sous-titre minuscule (« tenantName · Dossier de preuves »). Pour Sylvie, le document **n'est pas émis par Guillaume** — il est émis par MemorIA. Inversion de la relation. Sylvie n'est pas cliente de MemorIA, elle est cliente de NetCal.
...
**7. Pas de téléchargement permanent sécurisé.** Une fois le lien expiré (21 mai), si Sylvie a perdu son PDF, elle dépend de Guillaume pour relancer un nouveau lien. Pour son **archive qualité hôpital** qui doit être conservée 5 ans par réglementation HAS, c'est gênant. Elle aimerait un PDF avec une URL stable de vérification qui survit à l'expiration du lien éphémère.

**8. Aucune réponse possible côté Sylvie.** Elle voudrait dire « j'ai bien reçu » ou « pourrais-tu compléter avec X ». Aujourd'hui, elle doit retourner sur Outlook, écrire un mail à Guillaume. Friction. Le lien MemorIA l'a fait sortir de son flux mail pour rien — elle y retourne.
...
**10. La preuve d'envoi n'est pas certifiée.** Guillaume peut prétendre qu'il a envoyé le 14 mai. Sylvie n'a que son mail Outlook comme preuve. Si litige, elle voudrait un horodatage signé du « partage du lien » indépendant de la boîte Outlook de Guillaume.
...
- **Forwarder le mail** original de Guillaume à la directrice générale adjointe avec un commentaire de deux lignes
...
Sylvie, sous trois mois de pratique, va envoyer des demandes à Guillaume (qui les remontera à MemorIA). Chaque demande doit avoir une réponse doctrinale **préparée**.

| Demande probable | Risque doctrinal | Réponse |
|---|---|---|
| « Guillaume, fais en sorte que ton outil m'envoie le rapport direct par mail le 5 du mois » | Devenir émetteur à la place du prestataire | ❌ Refus. Guillaume reste l'expéditeur. MemorIA ne mail jamais le client final. Sinon MemorIA devient l'interlocuteur. Dérive vers SaaS B2B2C — le client se fidélise à la plateforme, pas au prestataire. |
| « Je veux commenter directement sur le document » | Portail client = grosse dérive | ❌ Refus. Pas de commentaires inline. Sylvie répond à Guillaume par mail. MemorIA n'est pas une messagerie. |
| « Je veux voir l'historique cumulé de tous les rapports de Guillaume » | Portail client permanent avec login | ❌ Refus. Un lien = un document. Si Sylvie veut un historique, elle doit demander à Guillaume (le prestataire reste l'interlocuteur). Si on cède : MemorIA devient un mini-portail, le moat de « scope assumé » s'effrite. |
| « Je veux voir les noms des agents qui ont fait la 312 » | Doctrine V3 anonymisation | ⚠️ Tension. Réponse : un override `include_identities` existe **côté Guillaume** (audit + justification écrite). Guillaume peut le faire à la demande, ponctuellement, pour un dossier juridique. Mais ce n'est **pas** un mode par défaut, et ce n'est **pas** une décision de Sylvie. Le prestataire reste maître de l'exposition. |
| « Je veux noter Guillaume » | Rating = mesure individuelle | ❌ Refus net. MemorIA ne fera **jamais** de système de note client. Glissement immédiat vers KPI fournisseur, comparaison, classement. C'est la fin du produit. Sylvie a Excel pour ça. |
| « Guillaume voit que j'ai ouvert le lien à 10h53 » | Tracking client | ❌ Refus. Le compteur `access_count` interne audit ne doit **jamais** remonter en granularité « date d'ouverture » à Guillaume. Guillaume voit « consulté oui/non » à la rigueur. Pas plus. Le client final n'est pas surveillé. |
| « MemorIA envoie un mail à Sylvie automatiquement le 5 du mois » | MemorIA devient l'auteur | ❌ Refus. Guillaume reste celui qui clique « envoyer ». Pas d'automatisation transparente. Le rapport mensuel doit avoir un instant humain de validation. |
...
| « Sylvie demande à recevoir une alerte SMS dès qu'une anomalie est résolue sur son site » | Notification client | ❌ Refus. Pas de canal direct MemorIA → client final. Tout passe par Guillaume. |
| « Sylvie veut télécharger un export Excel des interventions du trimestre » | Reverse-engineering KPI | ⚠️ Si export, **anonymisé**, sans noms, sans durées calculées par agent. Mieux : refuser et rediriger vers Guillaume qui peut générer un récap. |

**Principe transversal** : *Sylvie consulte. Sylvie n'opère pas. MemorIA est le canal de Guillaume vers Sylvie, jamais le serviteur de Sylvie.*
...
**Co-branding sobre prestataire + plateforme.** En haut du PDF et de la page web : « *Document émis par NetCal · Plateforme de preuves MemorIA* ». Logo de l'entreprise Guillaume (NetCal) à gauche, marque MemorIA à droite, séparateur fin. Permet à Sylvie de reconnaître Guillaume instantanément, tout en gardant la signature de tiers. **Sylvie est cliente de NetCal, pas de MemorIA** — l'UI doit refléter ça.

**Lettre d'accompagnement DG (optionnelle, courte).** Pour un dossier d'incident comme la salle 312, Guillaume devrait pouvoir attacher 3-6 lignes signées en haut du document : *« Madame Robineau, je vous adresse ce dossier suite à l'incident remonté le 6 mai. Le dossier détaille les preuves de la prestation et les mesures prises. Guillaume X. »* Pas une note IA, pas un template — un champ libre validé à l'envoi, comme la note DG du rapport mensuel. **Incarne le document.**

**URL stable de vérification + lien éphémère séparés.** Aujourd'hui, le lien `/p/[token]` est à la fois la consultation ET la vérification, et il expire. Séparer : (a) le **lien de consultation** éphémère (sécurité, 7 jours) que Guillaume partage à Sylvie, (b) une **URL stable de vérification** imprimée sur le PDF qui ne fait que confirmer « ce document existe, voici son hash, voici sa date d'émission ». Sylvie peut faire vérifier le PDF 3 ans plus tard sans dépendre de Guillaume. Tier vérification anonyme, pas de données revealed, juste un check d'intégrité.
...
- **Portail client avec login** → grosse dérive d'architecture. Devient une plateforme B2B2C. Refus immédiat. Guillaume reste l'interlocuteur unique de Sylvie.
...
- **Note / rating de la prestation par Sylvie** → glissement immédiat vers KPI fournisseur, comparaison de Guillaume avec d'autres prestataires MemorIA. Refus net, irréversible.
- **Tracking de Sylvie côté Guillaume** (« Guillaume voit que Sylvie a ouvert à 10h53, a passé 1m50, n'est jamais revenue ») → Sylvie est cliente, pas suspecte. Refus net. Audit interne anonymisé OK ; remontée granulaire à Guillaume non.
...
- **Compteur public « Guillaume a partagé 47 dossiers ce trimestre »** → faux signal d'autorité, et premier pas vers la mesure du prestataire par le client. Refus.
...
*Effet* : Sylvie reconnaît Guillaume immédiatement, le document n'est plus « émis par MemorIA » mais « émis par NetCal via MemorIA ». Restaure la relation commerciale réelle. Augmente le sentiment d'autorité sans verser dans le marketing.
...
*Effet* : incarne le document. Sylvie sent que Guillaume est derrière. Bascule la perception de « machine » vers « Guillaume avec un outil pro ». C'est l'antidote le plus direct à la critique #4 (« pas de signature humaine »).
