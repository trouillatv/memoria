...
**HARD STOP.** B1 livré (gate + tests + dry-run). Avant d'aller plus loin, ton GO pour **A** (backfill
Bella des 2 orphelins, réversible) et/ou **B2** (composite). Ces deux-là restent séparés.
