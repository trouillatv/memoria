  ...
  it('shows what the site knows and what awaits a human, not just detectors', () => {
    render(
      <MemoryWorkspace
        ...
        review={{
          confirmed: [
            { id: 'k-1', group: 'Décisions', title: 'Les accès seront communiqués ultérieurement', nature: null, href: null, knowledgeEntryId: null, durable: true, thematicCategory: null, sourceCount: 0 },
          ],
          toReview: [
            {
              id: 'p-1',
