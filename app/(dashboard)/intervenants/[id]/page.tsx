        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              ...
              (cette semaine). Plus la couleur est foncée, plus il y a eu
              d&apos;interventions ce jour-là. Aujourd&apos;hui : carré entouré.
            </p>
            {traces.lastTraceAt && (
...
function HeatmapCalendar({ cells, days }: HeatmapCalendarProps) {
  ...
  // Layout GitHub-like (Vincent 2026-05-21) :
  //   1 colonne = 1 semaine (lundi en haut, dimanche en bas)
  //   Les colonnes avancent de gauche (plus ancien) à droite (plus récent)
  //   La semaine en cours est la colonne la plus à droite.
  ...
  // Construire les colonnes (semaines). Padding début pour aligner sur lundi
  // au sommet de chaque colonne.
  const weeks: string[][] = []
  let currentWeek: string[] = []
  for (const date of dates) {
    const dow = new Date(date + 'T00:00:00Z').getUTCDay() // 0=dim, 1=lun
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-start gap-1">
        {/* Colonne labels jours de la semaine */}
        ...
        {/* Grille des colonnes (1 colonne = 1 semaine, lun→dim verticalement) */}
        <div
