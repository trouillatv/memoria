...
import { shortestPath, graphTimeline, REL_SOURCE_LABEL, type ActorsGraph, type ActorGraphNode } from '@/lib/knowledge/actors-graph-model'
...
export function useGraphExplorer(graph: ActorsGraph, focusId?: string | null) {
  ...
  return { selNode, selEdge, followFrom, pathSteps, narration, relations, nodeById, timeline, control, setTimeMax, selectNode, selectEdge, startFollow, clearPath }
}
