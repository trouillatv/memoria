...
// P0-2 — badge d'état de la fiche = projection opérationnelle COURANTE partagée (displayState),
// jamais le rawStatus. Même vérité que la fiche mobile et le Suivi (deriveCanonicalCurrentState).
