...
export const AGENTS: Record<ChatAgentName, AgentMeta> = {
  general:           { label: 'Général',            description: 'Assistant généraliste, répond à toutes vos questions sur le dossier',  signatureQuestion: 'Que faut-il savoir en priorité ?',           icon: Sparkles },
  lecteur_ao:        { label: 'Lecteur de dossier', description: 'Spécialiste de la lecture critique du cahier des charges',              signatureQuestion: 'Que dit vraiment le cahier des charges ?',  icon: FileSearch },
