...
import { rescheduleInterventionAction, getAvailableSlotsAction } from './intervention-actions'

export function RescheduleTrigger({ interventionId }: { interventionId: string }) {
  ...
  return (
    <>
      ...
      <RescheduleDialog
        ...
        fetchSlots={getAvailableSlotsAction}
        reschedule={rescheduleInterventionAction}
        variant="desktop"
      />
    </>
  )
