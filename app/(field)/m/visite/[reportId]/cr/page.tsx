...
export default async function VisitCrPreviewPage({
  ...
  return (
    <div className="mx-auto min-h-dvh max-w-md space-y-3.5 px-4 pb-16 pt-5">
      ...
      {/* Le brut (constats vocaux inclus) ne s'affiche plus ici : la synthèse
          ci-dessus fait foi, et la transcription complète reste accessible dans
          « Voir les données d'origine ». Le brut sert de preuve, jamais de contenu. */}
