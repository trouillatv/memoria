...
export function SiteReportLauncher({ siteId, siteName, contractId, contractName, variant = 'mobile', label, resumeReportId }: Props) {
  ...
  const buttonClass =
    variant === 'desktop'
      ...
      : 'inline-flex items-center justify-center gap-2 h-full w-full rounded-xl border bg-muted/30 shadow-sm text-foreground py-3.5 text-sm font-medium active:brightness-95 transition'
