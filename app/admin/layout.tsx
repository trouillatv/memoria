      ...
      <header className="bg-slate-900 text-white border-b border-slate-800">
        <div className="w-full px-4 md:px-8 py-3">
          ...
          <nav className="grid grid-cols-2 gap-1 md:flex md:items-center md:gap-5">
            ...
            <Link href="/admin/copilot"      className="text-center md:text-left text-sm font-medium text-slate-200 hover:text-white bg-slate-800 md:bg-transparent rounded px-2 py-2 md:p-0">Copilote</Link>
            ...
            <Link href="/admin/live-writer"  className="text-center md:text-left text-sm font-medium text-slate-200 hover:text-white bg-slate-800 md:bg-transparent rounded px-2 py-2 md:p-0">Live Writer</Link>
