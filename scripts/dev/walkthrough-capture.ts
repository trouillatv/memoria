...
async function run() {
  ...
  // ===================== ADMIN / PILOTE =====================
  {
    ...
    await goto(page, '/admin/users', 'admin-users', role)
    await goto(page, '/admin/observation', 'admin-observation', role)
    await goto(page, '/admin/monitoring', 'admin-monitoring', role)
