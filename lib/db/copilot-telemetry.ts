...
export interface CopilotInteractionInput {
  ...
  // Proposition 3C
  proposalKind?: 'action' | 'visit_item' | 'schedule_visit' | 'schedule_meeting' | 'observation' | 'actor_alias' | 'fact' | 'relation_claim' | 'watchpoint' | 'deadline' | 'reserve' | 'knowledge_supersession' | 'knowledge_archive' | null
